...
CREATE TABLE `carportdb`.`materials` (
  ...
  `helptext_base` VARCHAR(500) NOT NULL DEFAULT 'Ingen hjælpetekst',
  `helptext_roof` VARCHAR(500) NOT NULL DEFAULT 'Ingen hjælpetekst',
  `helptext_shed` VARCHAR(500) NOT NULL DEFAULT 'Ingen hjælpetekst',
