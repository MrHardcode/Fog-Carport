...
*/
INSERT INTO `carportdb`.`orders` (`build_adress`, `build_zipcode`, `status`, `width`, `length`, `incline`, `roof_tiles_id`, `shed_width`, `shed_length`, `shed_walls_id`, `shed_floor_id`, `customer_id`, `employee_id`) VALUES ('Roadson 1, 9', '2000', 'Processing', '3300', '6000', '0', '37', '2100', '2100', '1', '1', '1', '2');
