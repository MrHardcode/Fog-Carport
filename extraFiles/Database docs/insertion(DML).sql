...
INSERT INTO `carportdb`.`materials` (`description`, `height`, `width`, `length`, `cost_price`, `unit`, `id_category`, `helptext_base`, `helptext_shed`) VALUES ('97x97 mm. trykimp. Stolpe', '97', '97', '3000', '65', 'Stk', '1', 'Stolper nedgraves 90 cm. i jord + skråstiver', 'stolper til skur');
INSERT INTO `carportdb`.`materials` (`description`, `height`, `width`, `length`, `cost_price`, `unit`, `id_category`, `helptext_base`, `helptext_shed`, `helptext_roof`) VALUES ('45x195 spærtræ ubh.', '45', '195', '4800', '32.75', 'Stk', '1', 'Remme i sider, sadles ned i stolper Carport del', 'Remme i sider, sadles ned i stolper Skur del', 'Spær til tag');
INSERT INTO `carportdb`.`materials` (`description`, `height`, `width`, `length`, `cost_price`, `unit`, `id_category`, `helptext_shed`, `helptext_roof`) VALUES ('45x95 Reglar ubh.', '45', '95', '2400', '22', 'Stk', '1', 'Løsholter i skur', 'Spær til tag');
INSERT INTO `carportdb`.`materials` (`description`, `height`, `width`, `length`, `cost_price`, `unit`, `id_category`, `helptext_shed`, `helptext_roof`) VALUES ('45x95 Reglar ubh.', '45', '95', '3600', '27.5', 'Stk', '1', 'Løsholter i skur', 'Spær til tag');
...
INSERT INTO `carportdb`.`materials` (`description`, `height`, `width`, `length`, `cost_price`, `unit`, `id_category`, `helptext_shed`, `helptext_roof`) VALUES ('19x100mm. trykimp. Bræt', '19', '100', '2100', '21', 'Stk', '1', 'Beklædning på skur', 'Gavl beklædning');
...
INSERT INTO `carportdb`.`materials` (`description`, `cost_price`, `unit`, `id_category`, `helptext_roof`, `helptext_shed`) VALUES ('5,0x40mm. Beslagskruer (250 stk)', '125', 'Pakke', '2', 'Til montering af universalbeslag + toplægte', 'skruer til beslag');
...
INSERT INTO `carportdb`.`materials` (`description`, `height`, `width`, `length`, `cost_price`, `unit`, `id_category`, `helptext_roof`, `helptext_shed`) VALUES ('25x200mm alm. Bræt (Birk)', '25', '200', '2400', '35', 'Stk', '3', 'Beklædning af gavlen', 'Beklædning af skur');
INSERT INTO `carportdb`.`materials` (`description`, `height`, `width`, `length`, `cost_price`, `unit`, `id_category`, `helptext_roof`, `helptext_shed`) VALUES ('25x200mm alm. Bræt (Birk)', '25', '200', '3200', '47.5', 'Stk', '3', 'Beklædning af gavlen', 'Beklædning af skur');

/* More options for remme & spær */
INSERT INTO `carportdb`.`materials` (`description`, `height`, `width`, `length`, `cost_price`, `unit`, `id_category`, `helptext_base`, `helptext_shed`,`helptext_roof`) VALUES ('45x195 spærtræ ubh.', '45', '195', '6000', '45', 'Stk', '1', 'Remme i sider, sadles ned i stolper Carport del', 'Remme i sider, sadles ned i stolper Skur del','Spær til tag'); /*forgotten in initial push, adding here to avoid ID increment */
...
INSERT INTO `carportdb`.`materials` (`description`, `height`, `width`, `length`, `cost_price`, `unit`, `id_category`, `helptext_shed`, `helptext_roof`) VALUES ('25x200 mm. trykimp. Bræt (Birk)', '25', '200', '5400', '42.75', 'Stk', '1', 'Beklædning af skur', 'Understernbrædder til siderne');
...
/* Flat roof Awaiting (No shed) */
INSERT INTO `carportdb`.`orders` (`build_adress`, `build_zipcode`, `status`, `width`, `length`, `incline`, `roof_tiles_id`, `shed_walls_id`, `shed_floor_id`, `customer_id`, `employee_id`) VALUES 
('Nørgaardsvej 31', '2800', 'Awaiting', '7000', '6000', '0', '29', '10', '50', '1', '6');
INSERT INTO `carportdb`.`orders` (`build_adress`, `build_zipcode`, `status`, `width`, `length`, `incline`, `roof_tiles_id`, `shed_walls_id`, `shed_floor_id`, `customer_id`, `employee_id`) VALUES 
('Nørgaardsvej 31', '2800', 'Awaiting', '6000', '5000', '0', '29', '10', '51', '2', '6');
INSERT INTO `carportdb`.`orders` (`build_adress`, `build_zipcode`, `status`, `width`, `length`, `incline`, `roof_tiles_id`, `shed_walls_id`, `shed_floor_id`, `customer_id`, `employee_id`) VALUES 
('Nørgaardsvej 31', '2800', 'Awaiting', '5000', '4000', '0', '29', '10', '50', '3', '6');
INSERT INTO `carportdb`.`orders` (`build_adress`, `build_zipcode`, `status`, `width`, `length`, `incline`, `roof_tiles_id`, `shed_walls_id`, `shed_floor_id`, `customer_id`, `employee_id`) VALUES 
('Nørgaardsvej 31', '2800', 'Awaiting', '4000', '3000', '0', '29', '10', '51', '4', '6');
...
/*Raised Roof Awaiting (No shed) */
INSERT INTO `carportdb`.`orders` (`build_adress`, `build_zipcode`, `status`, `width`, `length`, `incline`, `roof_tiles_id`, `shed_walls_id`, `shed_floor_id`, `customer_id`, `employee_id`) VALUES 
('Nørgaardsvej 33', '2800', 'Awaiting', '3100', '7200', '25', '33', '56', '50', '1', '6');
INSERT INTO `carportdb`.`orders` (`build_adress`, `build_zipcode`, `status`, `width`, `length`, `incline`, `roof_tiles_id`, `shed_walls_id`, `shed_floor_id`, `customer_id`, `employee_id`) VALUES 
('Nørgaardsvej 33', '2800', 'Awaiting', '3100', '7200', '30', '34', '56', '51', '2', '6');
INSERT INTO `carportdb`.`orders` (`build_adress`, `build_zipcode`, `status`, `width`, `length`, `incline`, `roof_tiles_id`, `shed_walls_id`, `shed_floor_id`, `customer_id`, `employee_id`) VALUES 
('Nørgaardsvej 33', '2800', 'Awaiting', '3100', '7200', '35', '35', '56', '50', '3', '6');
INSERT INTO `carportdb`.`orders` (`build_adress`, `build_zipcode`, `status`, `width`, `length`, `incline`, `roof_tiles_id`, `shed_walls_id`, `shed_floor_id`, `customer_id`, `employee_id`) VALUES 
('Nørgaardsvej 33', '2800', 'Awaiting', '3100', '7200', '40', '36', '56', '51', '4', '6');
...
INSERT INTO `carportdb`.`orders` 
(`build_adress`, `build_zipcode`, `status`, `width`, `length`, `incline`, `roof_tiles_id`, `shed_width`, `shed_length`, `shed_walls_id`, `shed_floor_id`, `customer_id`, `employee_id`) VALUES 
('Nørgaardsvej 100', '2800', 'Awaiting', '5000', '6000', '0', '29', '2200', '3500', '56', '51', '2', '6');
INSERT INTO `carportdb`.`orders` 
(`build_adress`, `build_zipcode`, `status`, `width`, `length`, `incline`, `roof_tiles_id`, `shed_width`, `shed_length`, `shed_walls_id`, `shed_floor_id`, `customer_id`, `employee_id`) VALUES 
('Nørgaardsvej 100', '2800', 'Awaiting', '6000', '5000', '0', '29', '6000', '5000', '10', '50', '3', '6');
INSERT INTO `carportdb`.`orders` 
(`build_adress`, `build_zipcode`, `status`, `width`, `length`, `incline`, `roof_tiles_id`, `shed_width`, `shed_length`, `shed_walls_id`, `shed_floor_id`, `customer_id`, `employee_id`) VALUES 
('Nørgaardsvej 100', '2800', 'Awaiting', '3525', '4672', '0', '29', '2400', '2400', '10', '51', '4', '6');
INSERT INTO `carportdb`.`orders` 
(`build_adress`, `build_zipcode`, `status`, `width`, `length`, `incline`, `roof_tiles_id`, `shed_width`, `shed_length`, `shed_walls_id`, `shed_floor_id`, `customer_id`, `employee_id`) VALUES 
...
INSERT INTO `carportdb`.`orders` 
(`build_adress`, `build_zipcode`, `status`, `width`, `length`, `incline`, `roof_tiles_id`, `shed_width`, `shed_length`, `shed_walls_id`, `shed_floor_id`, `customer_id`, `employee_id`) VALUES 
('Nørgaardsvej 200', '2800', 'Awaiting', '6000', '5000', '25', '35', '6000', '5000', '10', '50', '3', '6');
INSERT INTO `carportdb`.`orders` 
(`build_adress`, `build_zipcode`, `status`, `width`, `length`, `incline`, `roof_tiles_id`, `shed_width`, `shed_length`, `shed_walls_id`, `shed_floor_id`, `customer_id`, `employee_id`) VALUES 
('Nørgaardsvej 200', '2800', 'Awaiting', '3525', '4672', '35', '36', '2400', '2400', '10', '51', '4', '6');
INSERT INTO `carportdb`.`orders` 
(`build_adress`, `build_zipcode`, `status`, `width`, `length`, `incline`, `roof_tiles_id`, `shed_width`, `shed_length`, `shed_walls_id`, `shed_floor_id`, `customer_id`, `employee_id`) VALUES 
('Nørgaardsvej 200', '2800', 'Awaiting', '4000', '6100', '45', '37', '3200', '5900', '10', '50', '4', '6');
